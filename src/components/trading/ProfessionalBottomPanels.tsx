          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} className="h-full flex flex-col">
            <div className="p-6 pb-0">
              <TabsList className="bg-muted/80 border border-border rounded-xl p-1.5 backdrop-blur-sm animate-fade-in shadow-elevation-2">
                <TabsTrigger 
                  value="trade" 
                  className="px-8 py-3 font-semibold data-[state=active]:bg-green-800 data-[state=active]:text-white data-[state=active]:shadow-lg data-[state=active]:shadow-primary/20 rounded-lg transition-all duration-300 hover-scale text-foreground hover:bg-accent/50"
                >
