...
const TradingTokenSidebar: React.FC<TradingTokenSidebarProps> = ({ 
  ...
  if (collapsed) {
    return (
      <motion.div 
        className="w-14 bg-gray-900/95 border-r border-gray-800/50 backdrop-blur-sm flex flex-col"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
  ...
  return (
    <motion.div 
      className="w-80 bg-gray-900/95 border-r border-gray-800/50 backdrop-blur-sm flex flex-col"
                ...
                >
                  {paginatedTokens.map((token, index) => {
                    ...
                    return (
                      ...
                      >
                        <Card 
                          className={`p-3 cursor-pointer transition-all duration-200 hover:scale-[1.02] group ${
                            isActive 
                              ...
                              <div className="relative">
                                {token.image ? (
                                  <img
                                    src={token.image}
                                    alt={`${token.name} logo`}
                                    className="h-10 w-10 rounded-full ring-1 ring-gray-700/50"
                                  />
                                ) : (
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-1">
              <Button
                ...
                className="h-8 w-8 p-0 bg-gray-800/50 border-gray-700/50 hover:bg-gray-700/50 disabled:opacity-30"
              >
                ...
                {Array.from({ length: Math.min(totalPages, 5) }).map((_, i) => {
                  ...
                  return (
                    <Button
                      ...
                      className="h-8 w-8 p-0 text-xs bg-gray-800/50 border-gray-700/50 hover:bg-gray-700/50"
                    >
                      {pageIndex + 1}
                    </Button>
                  );
