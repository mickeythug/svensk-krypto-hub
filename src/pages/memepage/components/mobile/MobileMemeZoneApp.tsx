              ...
              <div className="bg-gradient-to-r from-black/30 via-black/20 to-black/30 backdrop-blur-2xl rounded-3xl p-3 border border-white/20 shadow-2xl shadow-purple-500/10">
                <TabsList className="grid w-full grid-cols-4 bg-transparent gap-2">
                  ...
                  >
                    ...
                    <span className="text-xs font-semibold text-truncate-1">New</span>
                  </TabsTrigger>
                  <TabsTrigger 
                    value="gainers" 
                  ...
                  >
                    ...
                    <span className="text-xs font-semibold text-truncate-1">Gainers</span>
                  </TabsTrigger>
                  <TabsTrigger 
                    value="volume" 
                  ...
                  >
                    ...
                    <span className="text-xs font-semibold text-truncate-1">Volume</span>
                  </TabsTrigger>
                </TabsList>
              </div>
            </div>
