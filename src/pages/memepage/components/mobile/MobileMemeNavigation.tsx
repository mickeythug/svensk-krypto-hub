          ...
          {navItems.map((item) => {
            ...
            return (
              <Button
                ...
                className={`flex flex-col items-center gap-1 p-3 h-auto relative transition-all duration-300 ${
                  isActive 
              ...
              >
                ...
                {/* Badge */}
                {item.badge && (
                  <Badge className="absolute -top-1 -right-1 bg-gradient-to-r from-red-500 to-orange-500 text-white text-xs px-1.5 py-0.5 animate-pulse">
                    {item.badge}
                  </Badge>
                )}
              </Button>
