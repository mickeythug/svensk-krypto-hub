      ...
      <div className="bg-black/80 backdrop-blur-xl border-2 border-primary/30 rounded-3xl p-8 shadow-2xl">
        ...
        <div className="relative mb-12">
          ...
          <div className="relative bg-gradient-to-br from-yellow-500/90 via-yellow-400/95 to-yellow-600/90 backdrop-blur-xl border-4 border-yellow-400/50 rounded-3xl p-8 shadow-2xl">
            ...
            {/* Static Meme Token Images - Fixed Positions */}
            <div className="absolute z-20" style={{ left: '80px', top: '8px' }}>
              <div className="w-20 h-20 rounded-full overflow-hidden border-3 border-yellow-400/70 shadow-xl animate-float">
                <img 
            ...
            <div className="absolute z-20" style={{ left: '250px', top: '8px' }}>
              <div className="w-20 h-20 rounded-full overflow-hidden border-3 border-yellow-400/70 shadow-xl animate-float" style={{ animationDelay: '0.5s' }}>
                <img 
            ...
            <div className="absolute z-20" style={{ left: '420px', top: '8px' }}>
              <div className="w-20 h-20 rounded-full overflow-hidden border-3 border-yellow-400/70 shadow-xl animate-float" style={{ animationDelay: '1s' }}>
                <img 
            ...
            <div className="absolute z-20" style={{ left: '8px', top: '64px' }}>
              <div className="w-20 h-20 rounded-full overflow-hidden border-3 border-yellow-400/70 shadow-xl animate-float" style={{ animationDelay: '1.5s' }}>
                <img 
            ...
            <div className="absolute z-20" style={{ left: '8px', top: '120px' }}>
              <div className="w-20 h-20 rounded-full overflow-hidden border-3 border-yellow-400/70 shadow-xl animate-float" style={{ animationDelay: '2s' }}>
                <img 
            ...
            <div className="absolute z-20" style={{ left: '8px', top: '180px' }}>
              <div className="w-20 h-20 rounded-full overflow-hidden border-3 border-yellow-400/70 shadow-xl animate-float" style={{ animationDelay: '2.5s' }}>
                <img 
            ...
            <div className="absolute z-20" style={{ left: '470px', top: '64px' }}>
              <div className="w-20 h-20 rounded-full overflow-hidden border-3 border-yellow-400/70 shadow-xl animate-float" style={{ animationDelay: '3s' }}>
                <img 
            ...
            <div className="absolute z-20" style={{ left: '470px', top: '120px' }}>
              <div className="w-20 h-20 rounded-full overflow-hidden border-3 border-yellow-400/70 shadow-xl animate-float" style={{ animationDelay: '3.5s' }}>
                <img 
            ...
            <div className="absolute z-20" style={{ left: '470px', top: '180px' }}>
              <div className="w-20 h-20 rounded-full overflow-hidden border-3 border-yellow-400/70 shadow-xl animate-float" style={{ animationDelay: '4s' }}>
                <img 
            ...
            <div className="absolute z-20" style={{ left: '80px', top: '230px' }}>
              <div className="w-20 h-20 rounded-full overflow-hidden border-3 border-yellow-400/70 shadow-xl animate-float" style={{ animationDelay: '4.5s' }}>
                <img 
            ...
            <div className="absolute z-20" style={{ left: '420px', top: '230px' }}>
              <div className="w-20 h-20 rounded-full overflow-hidden border-3 border-yellow-400/70 shadow-xl animate-float" style={{ animationDelay: '5s' }}>
                <img 
                  src="/lovable-uploads/9767b44b-a881-4755-8bc3-bf3f207a3285.png"
                  alt="Doge Coin 2"
                  className="w-full h-full object-cover"
