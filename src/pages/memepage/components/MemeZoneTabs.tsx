            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-muted-foreground text-sm truncate">{token.name}</p>
                </div>
                ...
                <div className="hidden md:flex items-center gap-8">
                  ...
                  <div className="text-center">
                    ...
                    <p className="font-bold">{formatCompact(token.marketCap)}</p>
                  </div>
                  <div className="text-center">
                    <p className="text-xs text-muted-foreground">24H VOL</p>
                    <p className="font-bold">{formatCompact(token.volume24h)}</p>
                  </div>
                </div>
            ...
            >
              ...
              <div className="p-4 space-y-3">
                ...
                <div className="flex items-center justify-between mb-3">
                  <h3 className="font-black text-xl text-foreground truncate">
                    {token.symbol}
                  </h3>
                ...
                {/* Token Name */}
                <p className="text-muted-foreground text-sm font-medium truncate mb-1">{token.name}</p>
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div className="bg-muted/50 rounded-lg p-3 border">
                    ...
                    <div className="text-base font-black text-foreground">{formatPrice(token.price)}</div>
                  </div>
                  <div className="bg-muted/50 rounded-lg p-3 border">
                    <div className="flex items-center gap-2 text-muted-foreground text-xs mb-2">
                    ...
                    <div className="text-base font-black text-foreground">{formatCompact(token.marketCap)}</div>
                  </div>
                </div>
                ...
                {/* Action Button */}
                <Button 
                  className={`w-full bg-gradient-to-r from-primary to-primary/80 hover:from-primary/90 hover:to-primary text-primary-foreground font-bold h-12 rounded-lg transition-all duration-300 ${
