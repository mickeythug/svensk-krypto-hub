...
export default {
    ...
    extend: {
			...
			backgroundImage: {
				...
				'gradient-web3-cyber': 'var(--gradient-web3-cyber)',
				'gradient-meme-energy': 'var(--gradient-meme-energy)',
			},
			boxShadow: {
				'glow-primary': 'var(--glow-primary)',
				'glow-secondary': 'var(--glow-secondary)',
				'glow-casino-gold': 'var(--glow-casino-gold)',
			...
			fontFamily: {
				sans: ['Orbit', 'Inter', 'system-ui', 'sans-serif'],
